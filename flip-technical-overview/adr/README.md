...
These ADRs record stable, reviewer-relevant decisions. They omit private operational thresholds, credentials, proprietary prompts, and internal implementation history.

| ADR | Decision |
|---|---|
| [0001](0001-public-architecture-boundary.md) | Publish architecture and sanitized evidence without mirroring private implementation. |
